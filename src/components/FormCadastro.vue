        ...
        <div class="h-15 w-100">
            <v-card class="mx-auto pa-12 pb-8" elevation="6" max-width="448" rounded="lg">
                ...
                <v-text-field v-model="form.cpf" density="compact" placeholder="CPF" variant="outlined"
                    :rules="[required]" prepend-inner-icon="mdi-card-account-details-outline"></v-text-field>
                ...
                <v-text-field v-model="form.confirmPassword" density="compact" placeholder="Confirme sua senha"
                    variant="outlined"
                ...
                <v-card-text class="text-end pt-10 mb-n5">
                    ...
                    <router-link to="/login" class="text-blue-accent-4 text-decoration"
